...
#define CYBLE_RVAC_SENSOR_SENSORUSERCCCD_DESC_INDEX   (0x00u) /* Index of sensorUserCCCD descriptor */
#define CYBLE_RVAC_SENSOR_SENSORCCCD_DESC_INDEX   (0x01u) /* Index of sensorCCCD descriptor */
...
#define CYBLE_RVAC_SENSOR_SENSORUSERCCCD_DESC_HANDLE   (0x0013u) /* Handle of sensorUserCCCD descriptor */
#define CYBLE_RVAC_SENSOR_SENSORCCCD_DESC_HANDLE   (0x0014u) /* Handle of sensorCCCD descriptor */
