    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    static uint8 cyBle_attValues[0x75u] = {
    /* Device Name */
...
CYBLE_GATTS_ATT_GEN_VAL_LEN_T cyBle_attValuesLen[CYBLE_GATT_DB_ATT_VAL_COUNT] = {
    ...
    { 0x002Au, (void *)&cyBle_attValues[23] }, /* sensor */
    { 0x0014u, (void *)&cyBle_attValues[65] }, /* sensorUserCCCD */
    { 0x0002u, (void *)&cyBle_attValuesCCCD[2] }, /* sensorCCCD */
    { 0x0005u, (void *)&cyBle_attValues[85] }, /* Thermostat */
    { 0x0001u, (void *)&cyBle_attValues[90] }, /* thermoCCCD */
    { 0x000Au, (void *)&cyBle_attValues[107] }, /* thermoUserCCCD */
};
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x18u] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x00000001u /*        */, 0x0018u, {{0xD0AFu, NULL}}                           },
    { 0x0011u, 0x2803u /* Characteristic                      */, 0x00120001u /* rd,ntf */, 0x0014u, {{0x6B7Bu, NULL}}                           },
    { 0x0012u, 0x6B7Bu /* sensor                              */, 0x01120001u /* rd,ntf */, 0x0014u, {{0x002Au, (void *)&cyBle_attValuesLen[7]}} },
